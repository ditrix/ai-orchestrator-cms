...
- [Документ по разработке](DEVELOPMENT_RU.md) - подробное описание архитектуры и реализации
- [Документ по мануальному тестированию](MANUAL_TESTING.md) - инструкции по тестированию системы
- [Документ о процессе Vibe Coding](VIBE_CODING_RU.md) - описание workflow в данном проекте
